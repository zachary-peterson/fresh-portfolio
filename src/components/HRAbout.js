    ...
    return (
        <motion.div id='about' className='summary-container' variants={summary} initial='init' animate='after'>
            <motion.div className='about-me' variants={leterThree} initial='init' animate='after'>
                ...
                <br/>
                <motion.img src={scene1} alt='coromandel' width='100%'/>
            </motion.div>
            ...
            <motion.div className='photos'>
                <img src={bungee} width='75% ' alt='bungee jumping' />
                <img src={skydive} width='75%' alt='skydiving' />
                <img src={cave} width='75%' alt='spelunking' />
            </motion.div>
            </div>    
            </motion.div>
        </motion.div>
